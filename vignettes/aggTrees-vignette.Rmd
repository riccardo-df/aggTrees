...
This tutorial provides an overview of the core functions in the `aggTrees` package, which facilitates predictive modeling of ordered non-numeric outcomes:
